...
<body>
        ...
        <div class="container">
            <div class="header__inner">
                <div class="header__logo">
                    <a href="#">
                        <img src="./assets/img/main/logo-120-38.png" alt="zapadseo.com logo">
                    </a>
                </div>
    ...
    <main class="main">
            ...
            <div class="container">
                ...
                <div class="price">
                    ...
                    <div class="price__item price_yellow">
                        ...
                        <h3 class="price__title">SEO-продвижение</h3>
                        <div class="price__desc">Повышаем видимость сайта в поисковых системах для привлечения более качественного трафика.</div>
                ...
                <div class="advant">
                    ...
                    <div class="advant__item">
                        <div class="advant__header">
                            <img src="./assets/img/main/check-advant-blue.png" alt="">
                        </div>
                        <h3 class="advant__title">Продвижение на западе</h3>
                        <div class="advant__desc">Наше SEO агентство специализируется на продвижении сайтов за границей. Мы знаем, как успешно продвигать англоязычные сайты в США, Европе и других англоязычных странах.</div>
                    </div>

                    <div class="advant__item">
                        <div class="advant__header">
                            <img src="./assets/img/main/check-advant-yellow.png" alt="">
                        </div>
                        <h3 class="advant__title">Эффективность</h3>
                        <div class="advant__desc">У нас нет аккаунт-менеджеров. Вы общаетесь непосредственно с нашими SEO специалистами, что ускоряет работу и повышает эффективность.</div>
                    </div>
                    ...
                    <div class="advant__item">
                        ...
                        <h3 class="advant__title">Специализация на англоязычном рынке</h3>
                        <div class="advant__desc">Мы фокусируемся исключительно на англоязычных проектах, что позволяет нам глубоко понимать этот рынок и достигать лучших результатов.</div>
                    </div>
                    ...
                    <div class="advant__item">
                        ...
                        <h3 class="advant__title">Опытные специалисты</h3>
                        <div class="advant__desc">В команде "ZapadSEO" работают профессионалы с опытом более двух лет, которые знают, как достичь высоких позиций в поисковых системах.</div>
                    </div>
                    ...
                    <div class="advant__item">
                        ...
                        <h3 class="advant__title">Демократичные цены</h3>
                        <div class="advant__desc">Мы предлагаем конкурентоспособные цены на рынке англоязычного SEO при высоком качестве услуг.</div>
                    </div>
                    ...
                    <div class="advant__item">
                        ...
                        <h3 class="advant__title">Прозрачность</h3>
                        <div class="advant__desc">Мы гарантируем полную прозрачность в бизнес-процессах. Каждый месяц вы получаете отчеты по работам, показателям и используемому бюджету.</div>
                    </div>
                    ...
                    <div class="advant__item">
                        ...
                        <h3 class="advant__title">Белые методы продвижения</h3>
                        <div class="advant__desc">Мы используем только актуальные и белые методы продвижения, чтобы ваш сайт оставался в безопасности и на долгосрочной основе поднимался в топ-10 поисковиков, включая Google.</div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="cases">
                    ...
                    <div class="cases__item">
                        <div class="cases__inner">
                            <div class="cases__img">
                                <img src="./assets/img/page-seo/cases/cases-1.png" alt="">
                            </div>
                            <div class="cases__body">
                                ...
                                <div class="cases__list">
                                    <div class="cases__list-item"><span>Услуга</span><span>SEO-продвижение сайта за рубежом</span></div>
                                    <div class="cases__list-item"><span>Результат</span><span>Увеличение трафика в 3,5 раза</span></div>
                                </div>
                                <h3 class="cases__title">Увеличение органического трафика в 3 раза</h3>
                                <div class="cases__desc">
                                    <p>
                                        Один из наших клиентов, работающих в сфере туризма в Канаде, столкнулся с проблемой низкой видимости в поисковых системах. Мы провели глубокий анализ ключевых слов, оптимизировали контент и технические параметры сайта. В результате, за несколько месяцев органический трафик клиента увеличился в 3 раза, что привело к заметному росту бронирований.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="cases__item">
                        <div class="cases__inner">
                            <div class="cases__img">
                                <img src="./assets/img/page-seo/cases/cases-2.png" alt="">
                            </div>
                            <div class="cases__body">
                                <div class="cases__body-header">
                                    <div class="cases__tags">
                    ...
                    <div class="cases__item">
                        <div class="cases__inner">
                            <div class="cases__img">
                                <img src="./assets/img/page-seo/cases/cases-3.png" alt="">
                            </div>
                            <div class="cases__body">
                                <div class="cases__body-header">
                                    <div class="cases__tags">
        ...
        <div class="block">
            <div class="container">
                <div class="block__label">Этапы работы</div>
            ...
            <div class="container">
                ...
                <div class="advant">
                    ...
                    <div class="advant__item">
                        ...
                        <h3 class="advant__title">Захватите канадский рынок</h3>
                        <div class="advant__desc">Канада – это крупная и разнообразная страна с множеством потенциальных клиентов. Оптимизация сайта в Канаде позволит вам достичь аудитории, которая активно ищет продукты и услуги онлайн. Это отличная возможность увеличить объемы продаж и расширить вашу клиентскую базу.</div>
                    </div>
                    ...
                    <div class="advant__item">
                        ...
                        <h3 class="advant__title">Конкурентное преимущество</h3>
                        <div class="advant__desc">Конкуренция на рынке Канады может быть жесткой. Оптимизированный сайт позволит вам выделиться среди конкурентов. Ваш сайт будет более видимым в поисковых системах, что приведет к большему количеству кликов и потенциальным клиентам.</div>
                    </div>
                    ...
                    <div class="advant__item">
                        ...
                        <h3 class="advant__title">Улучшение пользовательского опыта</h3>
                        <div class="advant__desc">Оптимизация сайта в Канаде включает в себя работу над дизайном, скоростью загрузки страниц, удобством навигации и адаптивностью для мобильных устройств. Все это сделает ваш сайт более привлекательным для посетителей и повысит уровень их удовлетворенности.</div>
                    </div>
                    ...
                    <div class="advant__item">
                        ...
                        <h3 class="advant__title">Локальная адаптация</h3>
                        <div class="advant__desc">Оптимизация сайта в Канаде также включает в себя адаптацию под локальный рынок. Это означает использование ключевых слов и фраз, которые актуальны для канадских пользователей, а также учет особенностей местной культуры и тенденций.</div>
                    </div>
                    ...
                    <div class="advant__item">
                        ...
                        <h3 class="advant__title">Увеличение доверия</h3>
                        <div class="advant__desc">Канадские пользователи часто полагаются на поисковые системы, чтобы найти надежные и качественные товары и услуги. Оптимизированный сайт, который появляется на вершине результатов поиска, создает впечатление надежности и профессионализма.</div>
                    </div>
                    ...
                    <div class="advant__item">
                        ...
                        <h3 class="advant__title">Экономия ресурсов</h3>
                        <div class="advant__desc">Оптимизация сайта в Канаде помогает снизить расходы на рекламу и продвижение. Когда ваш сайт занимает высокие позиции в поисковых системах, вы получаете органический трафик, который более стабилен и долгосрочен.</div>
                    </div>
                    ...
                    <div class="advant__item">
                        ...
                        <h3 class="advant__title">Анализ и улучшение</h3>
                        <div class="advant__desc">Оптимизация сайта в Канаде включает в себя постоянный анализ и улучшение. Вы сможете отслеживать поведение пользователей, изучать их запросы и реакции, что позволит вам постоянно совершенствовать свой сайт и удовлетворять потребности аудитории.</div>
                    </div>
        ...
        <div class="block">
            <div class="container">
                <div class="block__label">Сравнительная характеристика</div>
                ...
                <div class="seoresult">
                    ...
                    <div class="seoresult__item">
                        <div class="seoresult__img">
                            <img src="./assets/img/page-seo/seoresult.png" alt="">
                        </div>
        ...
        <div class="block">
            <div class="container">
                <div class="block__label">Эффективное SEO-продвижение сайта</div>
                ...
                <div class="tools">
                    ...
                    <div class="tools__item">
                        <div class="tools__img">
                            <img src="./assets/img/page-seo/tools.png" alt="">
                        </div>
                        ...
                        <div class="review__item">
                            <div class="review__header">
                                <div class="review__img">
                                    <img src="./assets/img/page-seo/photo.png" alt="">
                                </div>
                ...
                <div class="team">
                    ...
                    <div class="team__list">
                        ...
                        <div class="team__item">
                            <div class="team__label">
                                <div class="team__icon">
                                    <img src="./assets/img/page-seo/team-icons/SEO-аналитик.png" alt="">
                                </div>
                        ...
                        <div class="team__item">
                            <div class="team__label">
                                <div class="team__icon">
                                    <img src="./assets/img/page-seo/team-icons/SEO-специалист.png" alt="">
                                </div>
                        ...
                        <div class="team__item">
                            <div class="team__label">
                                <div class="team__icon">
                                    <img src="./assets/img/page-seo/team-icons/Копирайтер-1.png" alt="">
                                </div>
                        ...
                        <div class="team__item">
                            <div class="team__label">
                                <div class="team__icon">
                                    <img src="./assets/img/page-seo/team-icons/Копирайтер-2.png" alt="">
                                </div>
                                <div class="team__position">Копирайтер</div>
                            </div>
                            <div class="team__count-spec">1 специалист</div>
                        ...
                        <div class="team__item">
                            <div class="team__label">
                                <div class="team__icon">
                                    <img src="./assets/img/page-seo/team-icons/Линкбилдер-1.png" alt="">
                                </div>
                        ...
                        <div class="team__item">
                            <div class="team__label">
                                <div class="team__icon">
                                    <img src="./assets/img/page-seo/team-icons/Линкбилдер-2.png" alt="">
                                </div>
                                <div class="team__position">Линкбилдер</div>
                            </div>
                            <div class="team__count-spec">1 специалист</div>
        ...
        <div class="block">
            <div class="container">
                <div class="block__label">Услуги</div>
